    ...
    return (
        <>
            <div className="container d-flex justify-content-center flex-column align-items-center mt-5">
                <h1 className="mt-5">Séries</h1>
                <div className="row" style={{marginTop: "3rem"}}>
                    {response.data.filter(f => f.type === "Série").map((f) => {
                        return (
                                <div className="col-sm-3 col-12 mt-sm-2 mt-5 cardSerie">
                                    <Link href={`series/${f.id}`}>
